...
def parse_args():
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default='/raid/Wei/Codes/TestCode/Multi_Level_Multi_attentional_Net/MLMA_Net/data/VOCdevkit2007/VOC/VOC_test/JPEGImages', type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default='/raid/Wei/Codes/TestCode/Multi_Level_Multi_attentional_Net/MLMA_Net/data/VOCdevkit2007/VOC/VOC_test/Annotations', type=str)
